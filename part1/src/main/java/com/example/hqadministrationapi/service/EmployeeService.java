...
public class EmployeeService {
    ...
    //Searching for employees via. what department they're in
    ...
    //Getting the name of the employee via. their id number, return an error if that employee doesn't exist
    @Transactional(readOnly = true)
